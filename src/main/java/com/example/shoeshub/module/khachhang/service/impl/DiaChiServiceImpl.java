...
public class DiaChiServiceImpl implements DiaChiService {
    ...
    @Override
    public List<DiaChi> getAddressesByCustomerId(Integer customerId) {
        return diaChiRepository.findByKhachHang_Makh(customerId);
    }
    @Override
    public void deleteAddress(Integer addressId) {
        diaChiRepository.deleteById(addressId); // Xóa địa chỉ theo ID
    }
}
