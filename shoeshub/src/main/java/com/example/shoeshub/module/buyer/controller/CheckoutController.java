...
//        String qrContent = "Mã hóa đơn: " + hoaDon.getTenhd() +
//                "\nTổng tiền: " + hoaDon.getTongtien() +
//                "\nTài khoản nhận: 0123456789 (Ngân hàng ABC)";
//        try {
//            String qrCodeImage = generateQRCode(qrContent, 200, 200); // Kích thước 200x200
//            model.addAttribute("qrCodeImage", qrCodeImage);
//        } catch (Exception e) {
//            model.addAttribute("qrCodeError", "Không thể tạo mã QR. Vui lòng thử lại.");
//            return "online/checkout";
//        }

        String qrImage = generateQRCode("Thanh toán QR Banking");
